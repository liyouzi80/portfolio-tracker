...
const mockAccounts = [
  { id: "1", name: "Main IB", currency: "USD", leverage: 1 },
  { id: "2", name: "长桥 (Longbridge)", currency: "HKD", leverage: 1.5 },
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-zinc-800 hover:bg-transparent">
                ...
                <TableHead className="text-zinc-500">Condition</TableHead>
            ...
            <TableBody>
              {mockAlerts.map((a) => (
                <TableRow key={a.id} className="border-zinc-800">
                  ...
                  <TableCell className="text-zinc-300">{a.condition === "price_below" ? "Below" : "Above"}</TableCell>
      ...
      <Card className="bg-zinc-900/50 border-zinc-800">
        ...
        <CardContent>
          <div className="flex items-center gap-4 text-sm">
            <span className="text-zinc-400">Price Provider:</span>
            <Badge className="bg-emerald-500/10 text-emerald-400">Longbridge (Primary)</Badge>
            <span className="text-zinc-600">→</span>
            <Badge variant="outline" className="border-zinc-700 text-zinc-500">Yahoo Finance (Fallback)</Badge>
          </div>
        </CardContent>
      </Card>
