...
// Static demo data — will be replaced with API fetch
const mockPortfolio = {
  baseCurrency: "CNY",
  totalValue: 285000,
  holdings: [
    { assetId: "1", symbol: "AAPL", name: "Apple Inc.", market: "US", currency: "USD", quantity: 50, avgCost: 175, totalCost: 8750 },
    { assetId: "2", symbol: "0700", name: "Tencent", market: "HK", currency: "HKD", quantity: 500, avgCost: 380, totalCost: 190000 },
    { assetId: "3", symbol: "600519", name: "Kweichow Moutai", market: "CN", currency: "CNY", quantity: 100, avgCost: 1780, totalCost: 178000 },
...
export function DashboardTab() {
  const totalPL = useMemo(() => {
    const currentTotal = 312000; // Would come from real-time prices
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="bg-zinc-900/50 border-zinc-800">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-normal text-zinc-400">Total Value</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-zinc-900/50 border-zinc-800">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-normal text-zinc-400">Today&apos;s P&amp;L</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-zinc-900/50 border-zinc-800">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-normal text-zinc-400">Total P&L</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-zinc-900/50 border-zinc-800">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-normal text-zinc-400">Holdings</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold tracking-tight">4</div>
            <div className="text-xs text-zinc-500 mt-1">3 markets</div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="md:col-span-2 bg-zinc-900/50 border-zinc-800">
          <CardHeader>
            <CardTitle className="text-sm font-medium">Net Value Curve</CardTitle>
          </CardHeader>
          <CardContent>
            <NetValueChart />
          </CardContent>
